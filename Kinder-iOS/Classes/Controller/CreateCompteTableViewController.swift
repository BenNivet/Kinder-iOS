//
//  CreateCompteTableViewController.swift
//  Kinder-iOS
//
...
class CreateCompteTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var createGender: UISegmentedControl!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NSLog("CreateCompteTableViewController")
        //Set button
